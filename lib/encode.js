...
function _encode(bytes, defers, value) {
  ...
  if (type === 'object') {
    //support for objects with toJSON method (added here as toJSON may return all kind of types including null, array and etc).
    if (value !== null && !(value instanceof Date) && !(value instanceof Buffer) && typeof value.toJSON === 'function')
      value = value.toJSON();
